...
import { 
  Plus, Copy, Eye, Edit, MoreHorizontal, Star, Trash2, FileText, Globe, List, Search
} from 'lucide-react'
  ...
  const handleDuplicate = async (template: AlromaihCarSpecificationTemplate) => {
    try {
      await fetchGraphQL(DUPLICATE_SPECIFICATION_TEMPLATE, { 
        id: template.id,
        new_name: `${getLocalizedText(template.name)} (Copy)`
      })
      toast({
        title: "Success",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage templates for organizing car specifications
          </p>
        </div>
        <Button 
          className="flex items-center gap-2" 
          onClick={() => router.push('/dashboard/specifications/templates/create')}
        >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage templates for organizing and displaying car specifications
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4 max-w-sm">
                Create templates to organize your car specifications and improve user experience
              </p>
              <Button onClick={() => router.push('/dashboard/specifications/templates/create')}>
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => router.push(`/dashboard/specifications/templates/${template.id}`)}>
